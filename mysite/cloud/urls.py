...
urlpatterns = [
        ...
        url(r'^(?P<platform_id>[0-9+])/get_vpcs_by_platform', views.get_vpcs_by_platform, name="get_vpcs_by_platform"),
        ...
        url(r'^instance/list', views.instance_list, name="instance_list"),
        url(r'^instance/delete', views.instance_delete, name="instance_delete"),
]
